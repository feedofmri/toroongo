...
TARGET_FILE = r'f:\Areas\Development\Projects\React\toroongo\frontend\src\data\mockData.js'
...
UNSPLASH_IDS = [
    "1618366712010-f4ae9c647dcb", "1517336714731-489689fd1ca8", "1527864550417-7fd91fc51a46",
    "1595225476474-87563907a212", "1556821840-3a63f95609a7", "1553062407-98eeb64c6a62",
    "1620916566398-39f1143ab7be", "1611930022073-b7a4ba5fcccd", "1507473885765-e6ed057ab6fe",
    "1542291026-7eec264c27ff", "1590658268037-6bf12f032f55", "1556679343-c7306c1976bc",
    "1523275335684-37898b6baf30", "1505740420928-5e560c06d30e", "1543163530-1073da1e94ba",
    "1560343090-f0409e92791a", "1572635196237-14b3f281503f", "1583394838336-acd977730f8a"
]
...
# Replace sellers
sellers_js = "export const sellers = " + json.dumps(sellers_data, indent=4) + ";"
content = re.sub(r'export const sellers = \[.*?\];', sellers_js, content, flags=re.DOTALL)

# Replace products
products_js = "export const products = " + json.dumps(products_data, indent=4) + ";"
content = re.sub(r'export const products = \[.*?\];', products_js, content, flags=re.DOTALL)

# Add testimonials at the end if not exists, or replace
testimonials_js = "\n// ─── Testimonials ───────────────────────────────────────────\n\nexport const testimonials = " + json.dumps(testimonials_data, indent=4) + ";"
if 'export const testimonials =' in content:
    content = re.sub(r'export const testimonials = \[.*?\];', testimonials_js, content, flags=re.DOTALL)
else:
    content += testimonials_js

with open(TARGET_FILE, 'w', encoding='utf-8') as f:
    f.write(content)

print("Successfully updated mockData.js with expanded data.")
