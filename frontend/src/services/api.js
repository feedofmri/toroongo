...
export const TOKEN_STORAGE_KEY = import.meta.env.VITE_AUTH_TOKEN_STORAGE_KEY || `${storagePrefix}_token`;
export const USER_STORAGE_KEY = import.meta.env.VITE_AUTH_USER_STORAGE_KEY || `${storagePrefix}_user`;
