...
const allSidebarLinks = [
  ...
  {
    to: "/seller/abandoned-carts",
    icon: ShoppingCart,
    labelKey: "abandonedCarts",
    featureKey: "abandoned",
  },
  {
    to: "/seller/blogs",
    icon: MessageSquare,
  ...
  {
    to: "/seller/social-commerce",
    icon: Share2,
    labelKey: "socialCommerce",
    featureKey: "social",
  },
  {
    to: "/seller/finance",
  ...
  },
  {
    to: "/seller/api",
    icon: Webhook,
    labelKey: "apiWebhooks",
    featureKey: "api",
  },
  {
    to: "/seller/affiliates",
    icon: Link2,
    labelKey: "affiliates",
    featureKey: "affiliate",
  },
  {
    to: "/seller/import-export",
    icon: Upload,
  ...
  return (
    <div className="min-h-screen bg-surface-bg flex flex-col" dir={i18n.dir()}>
      ...
      <div className="flex flex-1">
        {/* ── Sidebar ──────────────────────────────────────── */}
        <aside
          className={`hidden lg:flex flex-col w-60 bg-white border-border-soft min-h-screen sticky top-[64px] ${isRTL ? "border-l" : "border-r"}`}
        >
          {/* Logo + Plan Badge */}
          ...
          <nav className="flex-1 p-3 space-y-1">
            {sidebarLinks.map((link) => (
              ...
              >
                <link.icon size={16} />
                {t(
                  `sellerDashboard.nav.${link.labelKey}`,
                  link.fallbackLabel || link.labelKey,
                )}
              </NavLink>
            ))}
          </nav>
