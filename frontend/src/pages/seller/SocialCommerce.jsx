...
const INTEGRATIONS = [
    {
        ...
        description: 'Track visitor behavior, optimize ads, and build targeted audiences on Facebook & Instagram.',
        icon: '📘',
        status: 'connected',
    ...
    },
    {
        ...
        description: 'Sync your product catalog to Google Merchant Center and appear in Google Shopping results.',
        icon: '🛍️',
        status: 'connected',
    ...
    },
    {
        id: 'tiktok_pixel',
        name: 'TikTok Pixel',
        description: 'Track conversions from TikTok ads and build lookalike audiences for your store.',
        icon: '🎵',
        status: 'disconnected',
        pixelId: null,
        eventsTracked: 0,
    },
    {
        id: 'pinterest_tag',
        name: 'Pinterest Tag',
        description: 'Measure conversions from Pinterest and create rich product pins from your catalog.',
        icon: '📌',
        status: 'disconnected',
        pixelId: null,
        eventsTracked: 0,
                ...
                <div className="space-y-2">
                    {integration.pixelId && (
                        <div className="flex items-center justify-between p-2.5 bg-surface-bg rounded-lg">
                            <span className="text-[11px] text-text-muted">Pixel ID</span>
                    ...
                    {integration.feedUrl && (
                        <div className="flex items-center justify-between p-2.5 bg-surface-bg rounded-lg">
                            <span className="text-[11px] text-text-muted">Feed URL</span>
                            <button className="p-0.5 text-text-muted hover:text-brand-primary"><Copy size={10} /></button>
                        </div>
                    )}
                    {integration.eventsTracked > 0 && (
                        <div className="flex items-center justify-between p-2.5 bg-surface-bg rounded-lg">
                            <span className="text-[11px] text-text-muted">Events Tracked</span>
                    ...
                    {integration.productsListed && (
                        <div className="flex items-center justify-between p-2.5 bg-surface-bg rounded-lg">
                            <span className="text-[11px] text-text-muted">Products Synced</span>
                    ...
                    <div className="flex gap-2 pt-1">
                        <button className="flex-1 px-3 py-2 text-xs font-semibold text-text-primary bg-white border border-border-soft rounded-xl hover:bg-gray-50 transition-colors">
                            <Settings size={12} className="inline mr-1" />Configure
                        </button>
...
export default function SocialCommerce() {
        ...
        return (
            <div className="animate-fade-in py-12">
                <UpgradePrompt
                    ...
                    feature="Social Commerce Integrations"
                    requiredPlan="pro"
                    message="Connect Meta Pixel, Google Shopping, TikTok, and Pinterest to drive traffic and track conversions from social channels."
                    variant="card"
                />
            </div>
        );
    ...
    return (
        <div className="animate-fade-in space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-text-primary">Social Commerce</h2>
                <p className="text-text-muted text-sm mt-1">
                    Connect social platforms to sync products and track ad performance
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-2xl border border-border-soft">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-xs text-text-muted">Connected Platforms</span>
                    </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-border-soft">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-xs text-text-muted">Total Events Tracked</span>
                    </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-border-soft">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-xs text-text-muted">Attributed Sales</span>
                    </div>
