                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-border-soft">
                            {loading ? (
                                <tr>
                                    <td colSpan="7" className="px-5 py-8 text-center text-text-muted">Loading disputes...</td>
                                </tr>
                            ) : disputes.length === 0 ? (
                                <tr>
                                    <td colSpan="7" className="px-5 py-8 text-center text-text-muted">No active disputes</td>
                                </tr>
                            ) : disputes.map((d) => {
